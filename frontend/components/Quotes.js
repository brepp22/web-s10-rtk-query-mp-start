...
import { useGetQuotesQuery, useDeleteQuoteMutation,  useToggleApocryphalMutation } from '../state/quotesApi'
...
export default function Quotes() {
  ...
  const [toggleApocryphal , {isLoading: togglingQuote }] =  useToggleApocryphalMutation()
            ...
            .map(qt => (
              ...
              >
                ...
                <div className="quote-buttons">
                  ...
                  <button onClick ={() => toggleApocryphal({id : qt.id, quote : { apocryphal : !qt.apocryphal} })}>FAKE</button>
                </div>
              </div>
            ))
        }
